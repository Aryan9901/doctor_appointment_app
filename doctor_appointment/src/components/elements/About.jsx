...
const About = () => {
	return (
		<section className="w-full py-20 px-10 md:px-28 bg-[url(/blog_bg_1.jpg)] relative flex flex-wrap items-center justify-center">
			<img src="/dental_2.png" className="absolute right-6 top-12 animate-bounce duration-1000 h-36 hidden md:block" alt="dental teeth" />
			<img
				src="/dental_3.png"
				className="absolute left-6 bottom-12 animate-bounce duration-1000 h-36 hidden md:block"
				alt="dental stethoscope"
			/>
			...
			<div className="w-full md:w-1/2 flex flex-wrap items-center justify-center">
				...
				<div className="w-full md:w-3/4 h-auto md:h-56 mx-10 my-8 rounded-2xl flex flex-wrap border-2 border-[#05CE79]">
					<div
						className="w-full md:w-1/2 h-1/2 flex flex-col items-center justify-center gap-0"
					...
					<div
						className="w-full md:w-1/2 h-1/2 flex flex-col items-center justify-center gap-0"
						style={{ borderBottom: "2px solid #05CE79" }}
					>
						<h3 className="text-4xl font-semibold">
					...
					<div
						className="w-full md:w-1/2 h-1/2 flex flex-col items-center justify-center gap-0"
						style={{ borderRight: "2px solid #05CE79" }}
					>
						<h3 className="text-4xl font-semibold">
					...
					<div className="w-full md:w-1/2 h-1/2 flex flex-col items-center justify-center gap-0">
						<h3 className="text-4xl font-semibold">
